...
class PsUrl {
  ...
  static const String ps_transaction_cancel_url =
      'rest/transactionheaders/cancel_order/api_key/${PsConfig.ps_api_key}';

  static const String ps_shop_status_url =
      'rest/transactionheaders/shop_status/api_key/${PsConfig.ps_api_key}';

  static const String ps_transaction_enquiry =
      'rest/transactionheaders/enquiry/api_key/${PsConfig.ps_api_key}';
