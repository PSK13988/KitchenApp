...
class PsConfig {
  ...
  ///
  static const String ps_api_key = 'welcomekitchenind';
  ...
  static const String ps_app_url =
      'http://welcomekitchen.in/flutter-restaurant-admin/index.php/';//'https://www.panacea-soft.com/flutter-restaurant-admin/index.php/';

  static const String ps_app_image_url =
      'http://welcomekitchen.in/flutter-restaurant-admin/uploads/';//'https://www.panacea-soft.com/flutter-restaurant-admin/uploads/';

  static const String ps_app_image_thumbs_url =
      'http://welcomekitchen.in/flutter-restaurant-admin/uploads/thumbnail/';//'https://www.panacea-soft.com/flutter-restaurant-admin/uploads/thumbnail/';
