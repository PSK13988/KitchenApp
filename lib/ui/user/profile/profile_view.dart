...
class _TransactionListViewWidget extends StatefulWidget {
  ...
  @override
  __TransactionListViewWidgetState createState() =>
      __TransactionListViewWidgetState();
}

class __TransactionListViewWidgetState
    extends State<_TransactionListViewWidget> {
  @override
  Widget build(BuildContext context) {
        ...
        child: ChangeNotifierProvider<TransactionHeaderProvider>(
            ...
            create: (BuildContext context) {
              ...
              if (provider.psValueHolder.loginUserId == null ||
                ...
                provider.loadTransactionList(widget.userId);
              } else {
                provider
