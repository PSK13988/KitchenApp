    ...
    return SliverToBoxAdapter(
      child: ChangeNotifierProvider<UserProvider>(
        ...
        child: Consumer<UserProvider>(builder:
          ...
          provider.psValueHolder.phone ='';
          mobileController = TextEditingController(
              text: provider.psValueHolder.phone);
                                ...
                                children: <Widget>[
                                  ...
                                  _TermsAndConCheckbox(
                                    ...
                                    passwordTextEditingController:
                                        passwordController,
                                    mobileNumberTextEditingController: mobileController,
                                  ),
                                  const SizedBox(
                                    height: PsDimens.space8,
                                  ),
          ...
          onChanged: (bool value) {
            setState(() {
              updateCheckBox(
                  ...
                  widget.mobileNumberTextEditingController);
            });
          },
        ),
        Expanded(
...
void updateCheckBox(
  ...
  if (isCheckBoxSelect) {
    ...
    provider.psValueHolder.phone = mobileNumberTextEditingController.text;
...
class _TextFieldWidget extends StatefulWidget {
  ...
  final TextEditingController nameText, emailText, passwordText, mobileText;
  @override
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            margin: _marginEdgeInsetWidget,
            child: TextField(
              controller: widget.mobileText,
              style: Theme.of(context).textTheme.button.copyWith(),
              decoration: InputDecoration(
                  border: InputBorder.none,
                  hintText: Utils.getString(context, 'register__mobile_number'),
                  hintStyle: Theme.of(context)
                      .textTheme
                      .bodyText2
                      .copyWith(color: PsColors.textPrimaryLightColor),
    ...
    return Container(
      ...
      child: PSButtonWidget(
        ...
        onPressed: () async {
          if (widget.nameTextEditingController.text.isEmpty) {
          ...
          }else if (widget.mobileNumberTextEditingController.text.isEmpty) {
            callWarningDialog(context,
                Utils.getString(context, 'warning_dialog__input_mobile_number'));
          }
          else {
            ...
            widget.mobileNumberTextEditingController.text);
