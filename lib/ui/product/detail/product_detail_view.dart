                        ...
                        flexibleSpace: FlexibleSpaceBar(
                          background: Container(
                            ...
                            child: PsNetworkImage(
                              ...
                              //'latest${widget.product.defaultPhoto.imgId}',
...
class __AddToBasketAndBuyButtonWidgetState
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> addToBasketAndBuyClickEvent(bool isBuyButtonType) async {
      ...
      id =
          '${widget.product.id}$colorId ${widget.basketSelectedAttribute.getSelectedAttributeIdByHeaderId()}';
                    ...
                    children: <Widget>[
                      Expanded(
                        child: PSButtonWithIconWidget(
                          ...
                          onPressed: () async {
                            final Future<bool> checkShopStatus =
                                PskApiUtils.checkShopStatus(context);
                            checkShopStatus.then((bool response) {
                              if (response) {
...
class ShopStatusResponse {
  ...
  ShopStatusResponse(
      ...
      String openingHour,
      String closingHour,
      String currentHour,String message}) {
    _status = status;
  ...
  ShopStatusResponse.fromJson(dynamic json) {
    _status = json["status"];
    _openingHour = json["opening_hour"];
    _closingHour = json["closing_hour"];
    _currentHour = json["current_hour"];
  ...
  Map<String, dynamic> toJson() {
    ...
    map["status"] = _status;
    map["opening_hour"] = _openingHour;
    map["closing_hour"] = _closingHour;
    map["current_hour"] = _currentHour;
