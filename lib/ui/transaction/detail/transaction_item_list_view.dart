                      ...
                      slivers: <Widget>[
                        SliverToBoxAdapter(
                          child: _OrderStatusWidget(
                              // transactionDetail: provider.transa,
        ...
        builder: (BuildContext context, TransactionStatusProvider provider,
          ...
          return Container(
            ...
            child: CustomScrollView(
                ...
                shrinkWrap: true,
                slivers: <Widget>[
                  if (transaction.transStatus.title == 'Order Cancelled') SliverList(
                    delegate: SliverChildBuilderDelegate(
                      (BuildContext context, int index) {
              ...
              delegate: SliverChildBuilderDelegate(
                  ...
                  if (provider.transactionStatusList.data != null ||
                    ...
                    return _ColorCircleWidget(
                      ...
                      transaction: transaction,
                      statusLength:
                      provider.transactionStatusList.data.length - 1,
                    );
                  } else {
                    return null;
                  }
                },
                childCount: provider.transactionStatusList.data.length - 1,
              ),
            )
                ]),
          );
    ...
    return Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            _TransactionNoTextWidget(
              transationInfoText:
                  '${transaction.currencySymbol} ${Utils.calculateShippingTax(transaction.shippingAmount, valueHolder.shippingTaxValue)}',
              title:
