...
import 'package:flutterrestaurant/ui/our_services/our_services_tile_view.dart';
import 'package:flutterrestaurant/ui/privacy_policy/privacy_policy_view.dart';
import 'package:flutterrestaurant/ui/product/detail/views/terms_and_policy_tile_view.dart';
              ...
              builder:
                ...
                return ListView(padding: EdgeInsets.zero, children: <Widget>[
                  ...
                  _DrawerMenuWidget(
                      ...
                      title: Utils.getString(
                          context, 'home__menu_drawer_our_services'),
                      index: PsConst.REQUEST_CODE__MENU_OUR_SERVICES_FRAGMENT,
                      onTap: (String title, int index) {
                        Navigator.pop(context);
                        updateSelectedIndexWithAnimation(title, index);
                      }),
                  ...
                  _DrawerMenuWidget(
                      ...
                      title: Utils.getString(
                          context, 'terms_and_policy_tile__terms_and_policy'),
                      index: PsConst
                          .REQUEST_CODE__MENU_TERMS_AND_RETURN_POLICY,
                      onTap: (String title, int index) {
                        Navigator.pop(context);
                        updateSelectedIndexWithAnimation(title, index);
                      }),
            ...
            builder: (BuildContext context) {
              ...
              if (_currentIndex ==
                ...
                return PrivacyPolicyView(
                  ...
                  PsConst.REQUEST_CODE__MENU_TERMS_AND_RETURN_POLICY) {
                return TermsAndPolicyTileView(
                  //animationController: animationController,
                );
              }else if (_currentIndex ==
                  PsConst.REQUEST_CODE__MENU_OUR_SERVICES_FRAGMENT) {
                return OurServicesTileView(
                  //animationController: animationController,
                );
              }
              else if (_currentIndex ==
